            ...
            <tbody>
              {filtered.map(store => (
                <tr key={store.id}>
                  ...
                  <td>
                    <span className={`badge ${store.platform === 'webhotelier' ? 'badge-info' : store.platform === 'roomrack' ? 'badge-info' : store.platform === 'other' ? 'badge-other' : 'badge-neutral'}`}>
                      {store.platform === 'webhotelier' ? 'WebHotelier' : store.platform === 'roomrack' ? 'RoomRack' : store.platform === 'other' ? 'Manual' : 'HostHub'}
                    </span>
                  </td>
                  <td>
                    {store.api_key_name
